    ...
    <div>
      <article class="prose mx-40 mt-10">
        ...
        <ul>
          <li>
            <h3>VGG19</h3>
            <p>The VGG model was first proposed in a 2014 paper, "Very Deep Convolutional Neural Networks for Large-Scale Image Recognition", by computer scientists Andrew Zisserman and Karen Simonyan.</p>
